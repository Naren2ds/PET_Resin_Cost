...
DEFAULT_FILE_PATTERN = "Pricing_Pref*ABI*Cliente*.xlsx"
DEFAULT_OUTPUT_DIR = Path("data") / "archive" / "legacy_output"
DEFAULT_SHEET = "Inputs"
DEFAULT_RANGE = "G9:H13"
DEFAULT_RAW_CSV_NAME = "pricing_pref_inputs_raw.csv"
DEFAULT_LONG_CSV_NAME = "pricing_pref_inputs_long.csv"
...
def write_excel_output(
    ...
    write_rows_to_sheet(workbook, "raw_G9_H13", raw_rows)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract Pricing Pref Inputs G9:H13 into the PET data model."
    )
