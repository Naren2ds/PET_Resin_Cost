...
from .data.market_research import (
    DEFAULT_DESTINATION,
    DEFAULT_MONTH,
    DEFAULT_YEAR,
    ...
    available_destinations as available_market_destinations,
)
from .data.supplier import (
    available_destinations as available_supplier_destinations,
    build_vendor_breakdowns,
    supplier_price_for,
)
...
class CountriesResponse(BaseModel):
    ...
    availableDestinations: List[str] = []
...
def countries(
    ...
    vendor_breakdowns = (
        build_vendor_breakdowns(source_countries, selected_destination)
    ...
    return {
        ...
        "availableDestinations": sorted(
            set(available_market_destinations()) | set(available_supplier_destinations())
        ),
    }
