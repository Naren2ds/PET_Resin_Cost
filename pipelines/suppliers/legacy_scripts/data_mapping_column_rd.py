...
DEFAULT_OUTPUT_FILE = (
    Path("output") / "Pricing_Pref_ABI_RD_Men_4_26_Cliente_inputs_final.xlsx"
)
DEFAULT_MAPPING_FILE = Path("data") / "reference" / "mappings" / "Mapping_Columns.xlsx"
DEFAULT_MAPPING_SHEET = "Pricing_Pref_ABI_RD_Men_4_26_Cl"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Add Mapping Columns to the RD final_data sheet by metric_label_original."
    )
