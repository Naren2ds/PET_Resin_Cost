...
DEFAULT_OUTPUT_FILE = Path("data") / "archive" / "legacy_output" / "ABI 120326 -Pricing Marzo 2026_csd_resina_ush_final.xlsx"
DEFAULT_MAPPING_FILE = Path("data") / "reference" / "mappings" / "Mapping_Columns.xlsx"
DEFAULT_MAPPING_SHEET = "ABI 120326 -Pricing Marzo 2026"
DEFAULT_FINAL_SHEET = "final_data"
FINAL_LOOKUP_CANDIDATES = ["metric_label_original", "metric_name"]
MAPPING_LOOKUP_COLUMN = "metric_label_original"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Add Mapping Columns and calculation flags to the ABI 120326 Pricing Marzo final_data sheet."
        )
    )
